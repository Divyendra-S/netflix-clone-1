...
export const ManageAccounts = () => {
  const { Account, setAccount, setLoggedIn } = useContext(AppContext);
      ...
      <div className="flex h-screen justify-center  bg-gray-900 flex-col">
        ...
        <div className="text-center">
          <span
            ...
            className={`border text-white mt-2 ${
              Account.length < 1 ? " mt-24" : null
            } border-gray-100 cursor-pointer tracking-wide inline-flex text-sm px-[1.5em] py-[0.5em]`}
          >
            Manage Profiles
          </span>
        </div>
